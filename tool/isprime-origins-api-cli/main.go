...
import (
	...
	"github.com/maurodelazeri/image-uploader/client"
	"github.com/maurodelazeri/image-uploader/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "ISprime Origins API-cli",
		Short: `CLI client for the ISprime Origins API service`,
	}
	...
	c.UserAgent = "ISprime Origins API-cli/0"
